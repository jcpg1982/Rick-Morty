...
import pe.com.master.machines.domain.repositoryImpl.combine.GetSingleCharacterCombineUseCaseImpl
...
import pe.com.master.machines.domain.repositoryImpl.remote.GetEpisodesByIdsRemoteUseCaseImpl
...
abstract class DomainModule {
    ...
    @Binds
    @Singleton
    abstract fun providerGetSingleCharactersCombineUseCase(impl: GetSingleCharacterCombineUseCaseImpl): GetSingleCharacterCombineUseCase
    ...
    @Binds
    @Singleton
    abstract fun providerGetEpisodesByIdsRemoteUseCase(impl: GetEpisodesByIdsRemoteUseCaseImpl): GetEpisodesByIdsRemoteUseCase
}