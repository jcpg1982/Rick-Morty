...
class GetAllPetsUsesCaseTest {
    ...
    private val storyCharacterLocalDataRepository: StoryCharacterLocalDataRepository = mock()
    ...
    fun setup() {
        ...
        useCase = GetAllPetsUsesCase(petsNetworkDataRepository, storyCharacterLocalDataRepository)
    }
    ...
    fun `when local data is success and not empty, emits local data`() = runTest {
        ...
        whenever(storyCharacterLocalDataRepository.getAllPetsLocal())
    ...
    fun `when local data is error, fetches remote and saves`() = runTest {
        ...
        whenever(storyCharacterLocalDataRepository.savePets(remotePets))
        ...
        verify(storyCharacterLocalDataRepository).savePets(remotePets)
    }
