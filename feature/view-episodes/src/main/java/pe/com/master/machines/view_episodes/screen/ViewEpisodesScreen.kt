...
import pe.com.master.machines.design.components.row.EpisodeRow
...
fun ViewEpisodesScreen(
    ...
    val getStoryCharactersState by viewEpisodesViewmodel.getStoryCharactersState.collectAsStateWithLifecycle()
